              ...
              >
                ...
                <td style={{ padding: "0.75rem", display: "flex", gap: "0.5rem" }}>
                  ...
                  <button
                    className="btn btn-secondary"
                    style={{
                      backgroundColor: u.is_active ? "#dc3545" : "#28a745",
                    }}
        ...
        <div className="modal-backdrop">
          <div className="modal">
            ...
            <select
              className="input"
              onChange={(e) =>
                setSelectedUser((u: any) => ({ ...u, site_id: Number(e.target.value) }))
              }
            >
              <option value="">Sito</option>
              {sites.map((s) => (
      ...
      {showEditModal && selectedUser && (
        <div className="modal-backdrop">
          <div className="modal">
            ...
            <select
              className="input"
              defaultValue={selectedUser.site_id}
              onChange={(e) =>
                setSelectedUser({
                  ...selectedUser,
            ...
            <input
              className="input"
              defaultValue={selectedUser.id_lul}
              onChange={(e) =>
        ...
        <div className="modal-backdrop">
          <div className="modal">
            ...
            <input
              ...
              className="input"
              onChange={(e) =>
                setSelectedUser({ file: e.target.files?.[0] || null })
              }
            />
              ...
              <button
                ...
                onClick={async () => {
                  try {
                    ...
                    await userService.importUsers(selectedUser.file);
