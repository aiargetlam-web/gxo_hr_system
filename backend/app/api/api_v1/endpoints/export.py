...
def export_users(
    ...
    headers = [
        ...
        "Site ID", "ID LUL", "Active", "Created At"
    ]

    rows = [
        [
            u.id, u.first_name, u.last_name, u.email,
            u.role_id, u.current_site_id, u.lul_id,
...
def export_board(
    ...
    rows = [
        [f.id, f.file_name, f.hr_author_id, f.upload_date]
        for f in files
    ]
...
def export_activity_logs(
    ...
    headers = [
        "ID", "User ID", "Role", "Action",
        "Entity Type", "Entity ID", "IP Address", "Created At"
    ]

    rows = [
        [
            l.id, l.user_id, l.role, l.action,
...
def export_user_history(
    ...
    headers = [
        "ID", "Target User ID", "Field",
        "Old Value", "New Value", "Modified By ID", "Created At"
    ]

    rows = [
        [
            l.id, l.target_user_id, l.field_name,
            l.old_value, l.new_value, l.modified_by_id, l.created_at
        ]
        for l in logs
    ]
